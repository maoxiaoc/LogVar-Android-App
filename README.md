...
当前版本：**测试版 5.0.0（5.0.0-beta）**。服务随应用在手机本地运行，无需 Termux，也无需另行部署服务器。测试版的接口兼容性、后台运行和弹幕源可用性仍需持续验证。
...
在 [Releases](https://github.com/maoxiaoc/LogVar-Android-App/releases) 中选择 **Logvar 测试版 5.0.0**：

| 安装包 | 适用设备 |
| --- | --- |
| `Logvar-5.0.0-beta-arm64-v8a.apk` | 大多数现代 Android 手机 |
| `Logvar-5.0.0-beta-armeabi-v7a.apk` | 支持 32 位 ARM 应用的设备 |
| `Logvar-5.0.0-beta-x86_64.apk` | x86_64 设备或模拟器 |
