...
export const Globals = {
  ...
  searchCache: mobile ? new ResourceCache(64, 4 * 1024 * 1024, () => (Globals.envs.searchCacheMinutes || 10) * 60000) : new Map(),
  commentCache: mobile ? new ResourceCache(32, 16 * 1024 * 1024, () => (Globals.envs.commentCacheMinutes || 30) * 60000) : new Map(),
